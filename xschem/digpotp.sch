...
C {devices/lab_pin.sym} -10 -2670 0 0 {name=l5 sig_type=std_logic lab=gnd}
C {sky130_fd_pr/res_xhigh_po_0p35.sym} -10 -2315 3 0 {name=R2
W=0.35
L=0.52
model=res_xhigh_po_0p35
spiceprefix=X
mult=1}
C {devices/lab_pin.sym} -10 -2295 0 0 {name=l6 sig_type=std_logic lab=gnd}
C {sky130_fd_pr/res_xhigh_po_0p35.sym} -10 -1960 3 0 {name=R3
W=0.35
L=1.22
model=res_xhigh_po_0p35
spiceprefix=X
mult=1}
C {devices/lab_pin.sym} -10 -1940 0 0 {name=l7 sig_type=std_logic lab=gnd}
C {sky130_fd_pr/res_xhigh_po_0p35.sym} -10 -1585 3 0 {name=R4
W=0.35
L=2.62
model=res_xhigh_po_0p35
spiceprefix=X
mult=1}
C {devices/lab_pin.sym} -10 -1565 0 0 {name=l8 sig_type=std_logic lab=gnd}
C {sky130_fd_pr/res_xhigh_po_0p35.sym} -35 -1210 3 0 {name=R5
W=0.35
L=5.42
model=res_xhigh_po_0p35
spiceprefix=X
mult=1}
C {devices/lab_pin.sym} -35 -1190 0 0 {name=l9 sig_type=std_logic lab=gnd}
C {sky130_fd_pr/res_xhigh_po_0p35.sym} -10 -895 3 0 {name=R6
W=0.35
L=11.02
model=res_xhigh_po_0p35
spiceprefix=X
mult=1}
C {devices/lab_pin.sym} -10 -875 0 0 {name=l10 sig_type=std_logic lab=gnd}
C {sky130_fd_pr/res_xhigh_po_0p35.sym} -10 -520 3 0 {name=R7
W=0.35
L=22.22
model=res_xhigh_po_0p35
spiceprefix=X
mult=1}
C {devices/lab_pin.sym} -10 -500 0 0 {name=l11 sig_type=std_logic lab=gnd}
C {sky130_fd_pr/res_xhigh_po_0p35.sym} -35 -145 3 0 {name=R8
W=0.35
L=44.62
model=res_xhigh_po_0p35
spiceprefix=X
mult=1}
C {devices/lab_pin.sym} -35 -125 0 0 {name=l12 sig_type=std_logic lab=gnd}
C {sky130_fd_pr/res_high_po_0p35.sym} -10 -2690 3 0 {name=R1
W=0.35
L=1
